# PMCNet code. 
# Mostly based on https://github.com/ahyunSeo/PMCNet/tree/master/modeling, which is under MIT license.
import os
import datetime
import torch
...
class PMCNet(nn.Module):
    ...
    def forward(self, img, axis, lbl, mask, a_lbl=None):
